class Api::V1::ReviewsController < ApplicationController
  ...
  def create
    ...
    if review.save
      ...
      json_response "Create review fail", false, {}, :unproccesable_entity
    end
  rescue StandardError => e
    render_rescue(e)
  end
  ...
  def update
    if correct_user?(@review.user)
      if @review.update(set_review_params)
        ...
        json_response "Updated review fail", false, {}, :unproccesable_entity
      end
    else
      json_response "You do not have permission to do this", false, {}, :unauthorized
    end
  rescue StandardError => e
    render_rescue(e)
  end
  ...
  def destroy
    if correct_user?(@review.user)
      if @review.destroy
        ...
        json_response "Deleted review fail", false, {}, :unproccesable_entity
      end
    else
      json_response "You do not have permission to do this", false, {}, :unauthorized
    end
